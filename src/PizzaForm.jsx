      ...
      <FormControl>
            ...
            <Select disabled={readOnly}
              ...
              {baseKeys.map((base, i) => (
                <MenuItem class='customFont1' key={i} value={base}>
                  <Grid pr={3} className="customFont1" pt={1} container>
                    <Grid item pl={3} flexGrow={1}>
                      {bases[base].label}
                    </Grid>
                    <Grid item pr={3} flexend={1}>
        ...
        <Grid p={2} container>
          <Grid item flexGrow={1}>
            <Typography class='customFont1' pr={1} variant="h5">Total price:</Typography>
          </Grid>
          <Grid item>
            <Typography class='customFont1' variant="h5">£ {((totalPrice) / 100).toFixed(2)}</Typography>
          </Grid>
        </Grid>
        {!readOnly && (
